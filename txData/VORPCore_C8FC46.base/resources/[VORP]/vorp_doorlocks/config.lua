...
Config.Permissions = {
    -- police
    Sheriff = {      -- Name must match config.Doors.Perms can be any name it doesnt matter as long is unique in here
        Sheriff = 0, -- job name + grade if grade is 0 then anything above 0 has permissions if frade is 2 then anything above 2 has permissions
        -- Can add as many jobs as you wish
    },
    Marshal = {      -- Name must match config.Doors.Perms can be any name it doesnt matter as long is unique in here
        Marshal = 0, -- job name + grade if grade is 0 then anything above 0 has permissions if frade is 2 then anything above 2 has permissions
        -- Can add as many jobs as you wish
    },
...
Config.Doors = {
    ...
    [1988748538] = {
        ...
        Permissions = Config.Permissions.Sheriff,                       -- Will use the jobs for this location if false everyone can open and close doors
    ...
    [395506985]  = {
        ...
        Name = "Back Door",
        DoorState = 0,
        Permissions = Config.Permissions.Sheriff,
